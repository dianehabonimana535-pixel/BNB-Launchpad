    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative flex flex-col items-center gap-8 pb-24 pt-20 text-center md:pt-28">
        ...
        >
          ...
          Live on BNB Smart Chain & Robinhood Chain · No platform fee
        </motion.div>
        ...
        >
          Create and deploy your meme coin on BNB Smart Chain (BEP-20) or Robinhood Chain
          (ERC-20) effortlessly in seconds — logo, metadata, and authorities included. No
          platform fee — you only pay whatever the network itself charges.
        </motion.p>
        ...
        >
          {[
            { icon: Ban, label: "No platform fee", desc: "Free, no hidden costs" },
            { icon: ShieldCheck, label: "Non-custodial", desc: "We never see your keys" },
            { icon: Zap, label: "Mints in seconds", desc: "Pick your chain, no queue" },
          ].map((f) => (
