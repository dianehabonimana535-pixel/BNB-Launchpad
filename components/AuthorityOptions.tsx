...
const items: {
  ...
  },
  {
    ...
    before: "The holder of this authority can freeze any wallet's balance in this contract.",
  ...
  },
  {
    ...
    before: "The metadata pointer (logo, description, links) can still be changed later.",
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <p className="text-xs text-muted-foreground">
        Revoking an authority happens inside the same deployment transaction and cannot be
